    ...
    <div>
            ...
            <div>
                <div
                    ...
                    :style="{
                        ...
                        color: colorChange(item.color, 0.5, 1.0)
                    }"
                >
                    <span
                        style="
        ...
        >
            <span
                v-if="
                    Decimal.gte(
                        player.gameProgress.main.totals[3]!,
                        getSCSLAttribute('points', false)[0].start
                    )
                "
                style="text-align: center; font-size: 0.8vw; color: #f44"
            >
                Your points past {{ format(getSCSLAttribute("points", false)[0].start) }} is taxed
                by {{ getSCSLAttribute("points", false)[0].displayedEffect }}!
            </span>
            <span
                v-if="player.gameProgress.col.inAChallenge"
                style="text-align: center; font-size: 1.6vw"
                :style="{ color: player.gameProgress.col.completedAll ? '#0080FF' : '#FF4000' }"
            >
