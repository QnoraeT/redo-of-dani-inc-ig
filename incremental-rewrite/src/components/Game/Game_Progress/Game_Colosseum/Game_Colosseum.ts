...
import { COL_RESEARCH } from "./Game_ColResearches/Game_ColResearches";
...
export const updateCol = (type: number, delta: DecimalSource) => {
    ...
    switch (type) {
        case 1:
            ...
            break;
        case 0:
            // if (Decimal.lte(player.value.gameProgress.col.timeLeft, 0) && player.value.gameProgress.col.inAChallenge) {
            ...
            //         player.value.gameProgress.col.timeLeft = D(1);
            ...
            //         player.value.gameProgress.col.timeLeft = Decimal.sub(player.value.gameProgress.col.timeLeft, delta);
            //     }
            // } else {
            //     player.value.gameProgress.col.timeLeft = player.value.gameProgress.col.maxTime;
            // }
