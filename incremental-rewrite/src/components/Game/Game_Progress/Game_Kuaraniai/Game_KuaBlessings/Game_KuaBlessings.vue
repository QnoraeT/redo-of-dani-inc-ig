...
<template>
    <div style="margin-top: 0.2vw; background-color: #021; border: 0.2vw solid #0f4; margin-left: auto; margin-right: auto; display: flex; justify-content: center; flex-direction: row; box-shadow: 0 0 0.8vw 0.24vw rgb(0, 66, 17); height: 40vw; width: 80vw;">
        <div class="font0" style="display: flex; flex-direction: column; border: 0.24vw solid #0f4; padding: 0.6vw; height: 38.4vw; width: 50%;">
        ...
        <div class="flex-container" style="flex-direction: column; border: 0.18vw solid #0f4; height: 39.8vw; width: 50%;">
            <div v-if="KUA_BLESS_TIER.rank.show" class="flex-container whiteText font0" style="justify-content: center; background-color: #004010; position: relative; width: 100%; height: 15%;">
            ...
            <div v-if="KUA_BLESS_TIER.tier.show" class="flex-container whiteText font0" style="justify-content: center; background-color: #005014; position: relative; width: 100%; height: 15%;">
            ...
            <div v-if="KUA_BLESS_TIER.tetr.show" class="flex-container whiteText font0" style="justify-content: center; background-color: #004010; position: relative; width: 100%; height: 15%;">
                <div class="flex-container font0 whiteText" style="width: 95%; height: 80%; top: 7.5%; font-size: 0.6vw; position: relative; border: 0.18vw solid #0f4; background-color: #005014; align-items: center">
                    <div style="text-align: center; position: relative; width: 30%; left: 0%">
