...
<template>
    <div class="flex-horizontal" style="margin-top: 0.2vw; background-color: #021; border: 0.2vw solid #0f4; margin-left: auto; margin-right: auto; box-shadow: 0 0 0.8vw 0.24vw rgb(0, 66, 17); height: 40vw; width: 80vw;">
        <div class="font0 flex-vertical" style="border: 0.24vw solid #0f4; padding: 0.6vw; height: 38.4vw; width: 50%;">
            <span style="color: #0f2; text-align: center; font-size: 1.2vw">
                You have 
                <span style="font-size: 1.4vw"><b>{{ format(player.prog.kua.blessings.amount, 3) }}</b></span> 
                Kuaraniai Blessings. 
                <span style="font-size: 1vw">({{ format(tmp.kua.blessings.perSec, 2) }}/s)</span>
            </span>
            <span style="color: #0f2; text-align: center; font-size: 0.9vw">
                The most KBs you've had is
                <span style="font-size: 1.15vw"><b>{{ format(player.prog.kua.blessings.bestInCol, 3) }}</b></span>. 
            </span>
            ...
            <button class="whiteText font0" :class="{ nope: Decimal.gt(player.prog.kua.blessings.clickCooldown, 0), ok: Decimal.lte(player.prog.kua.blessings.clickCooldown, 0) }" style="padding: 0vw; width: 12vw; height: 2vw; background-color: #041; margin-top: 0.5vw; margin-left: auto; margin-right: auto" :style="{ cursor: Decimal.gt(player.prog.kua.blessings.clickCooldown, 0) ? 'not-allowed' : 'pointer' }" @click="gainKBOnClick()">
                <div class="whiteText flex-horizontal" style="position: relative; width: 100%; height: 70%; font-size: 0.6vw;">
                ...
                <div style="height: 30%; width: 100%; position: relative">
                    ...
                    <div
                        :style="{
                            width: `${
                                Decimal.sub(1, Decimal.max(player.prog.kua.blessings.clickCooldown, 0).div(0.25)).mul(100).toNumber()
                            }%`
                        }"
            ...
            <div class="flex-horizontal" style="margin-top: 0.4vw; flex-wrap: wrap;">
                <div v-for="(item, index) in KUA_BLESS_UPGS" :key="index">
                    ...
                    <button @click="buyKBUpg(index)" :class="{ nope: !tmp.kua.blessings.upgrades[index].canBuy, ok: tmp.kua.blessings.upgrades[index].canBuy}" :style="{ cursor: tmp.kua.blessings.upgrades[index].canBuy ? 'pointer' : 'not-allowed' }" v-if="item.show" style="width: 12vw; height: 8vw; margin-left: 0.15vw; margin-right: 0.15vw; margin-bottom: 0.3vw; font-size: 0.55vw; transition: 0.2s; background-color: #00300a" class="font0 whiteText">
                        <span style="margin-right: 0.5vw; color: #0d3"><b>#{{index + 1}}</b></span><span class="whiteText">×{{ format(player.prog.kua.blessings.upgrades[index]) }}</span><br>
        ...
        <div class="flex-vertical" style="border: 0.18vw solid #0f4; height: 39.8vw; width: 50%;">
            <div v-if="KUA_BLESS_TIER.rank.show" class="flex-vertical whiteText font0" style="background-color: #004010; position: relative; width: 100%; height: 15%;">
                <div class="flex-container font0 whiteText" style="width: 95%; height: 80%; top: 7.5%; font-size: 0.6vw; position: relative; border: 0.18vw solid #0f4; background-color: #005014; align-items: center">
                    ...
                    <div style="text-align: center; position: relative; font-size: 0.6vw; width: 70%; right: 0%">
                        Your KBlessing Ranks:<br>
                        <span>{{ KUA_BLESS_TIER.rank.desc.kuaBlessGainActive }}</span><br>
                        <span>{{ KUA_BLESS_TIER.rank.desc.kuaBlessGainIdle }}</span><br>
                    </div>
                </div>
            </div>
            <div v-if="KUA_BLESS_TIER.tier.show" class="flex-vertical whiteText font0" style="background-color: #005014; position: relative; width: 100%; height: 15%;">
                <div class="flex-container font0 whiteText" style="width: 95%; height: 80%; top: 7.5%; font-size: 0.6vw; position: relative; border: 0.18vw solid #0f4; background-color: #006018; align-items: center">
                    <div style="text-align: center; position: relative; width: 30%; left: 0%">
                    ...
                    <div style="text-align: center; position: relative; font-size: 0.6vw; width: 70%; right: 0%">
                        Your KBlessing Tiers:<br>
                        <span>{{ KUA_BLESS_TIER.tier.desc.kuaBlessEff }}</span><br>
                    </div>
                </div>
            </div>
            <div v-if="KUA_BLESS_TIER.tetr.show" class="flex-vertical whiteText font0" style="background-color: #004010; position: relative; width: 100%; height: 15%;">
                <div class="flex-container font0 whiteText" style="width: 95%; height: 80%; top: 7.5%; font-size: 0.6vw; position: relative; border: 0.18vw solid #0f4; background-color: #005014; align-items: center">
                    <div style="text-align: center; position: relative; width: 30%; left: 0%">
                    ...
                    <div style="text-align: center; position: relative; font-size: 0.6vw; width: 70%; right: 0%">
                        Your KBlessing Tetr:<br>
                        <span>{{ KUA_BLESS_TIER.tetr.desc.kuaRankActive }}</span><br>
                        <span>{{ KUA_BLESS_TIER.tetr.desc.kuaRankIdle }}</span><br>
                        <span>{{ KUA_BLESS_TIER.tetr.desc.pr2Eff }}</span><br>
                    </div>
                </div>
            </div>
        </div>
