        ...
        >
            ...
            >
                <div
                    ...
                    :style="{
                        color: gRC(4.5 + Math.sin(gameVars.sessionTime) / 4, 1.0, 1.0),
                        border: `0.18vw solid ${gRC(4.5 + Math.sin(gameVars.sessionTime + Math.PI * 0.5) / 8, 0.5, 1.0)}`
                    }"
                >
                    <div
                        style="text-align: center; font-size: 1vw"
                ...
                <div
                    ...
                    style="flex-direction: column; align-items: center"
                    :style="{
                        color: gRC(4.5 + Math.sin(gameVars.sessionTime + Math.PI) / 4, 1.0, 1.0),
                        border: `0.18vw solid ${gRC(4.5 + Math.sin(gameVars.sessionTime + Math.PI) / 8, 0.5, 1.0)}`
                    }"
                >
                    <div
                        style="text-align: center; font-size: 1vw"
                    ...
                    >
                        <div v-for="(item, index) in KUA_UPGRADES.KShards" :key="index">
                            <Kua_Upgrade
                                ...
                                :style="{
                                    opacity:
                                        0.5 ** (index - player.gameProgress.kua.kshards.upgrades)
                                }"
                                v-if="
                    ...
                    >
                        <div v-for="(item, index) in KUA_UPGRADES.KPower" :key="index">
                            <Kua_Upgrade
                                ...
                                :style="{
                                    opacity:
                                        0.5 ** (index - player.gameProgress.kua.kpower.upgrades)
                                }"
                                v-if="
