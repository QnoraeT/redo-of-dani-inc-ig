...
<template>
    <button style="margin-left: 0.16vw; margin-right: 0.16vw; width: 10vw; height: 10vw; font-size: 0.72vw" class="whiteText kuaButton2 fontVerdana">
        ...
        <br><br>
        <span style="vertical-align: bottom;"><b>Cost:</b><br>{{format(item.cost, 1)}} {{ type }}</span>
    </button>
</template>
